...
public class TopicBean  implements Serializable {
    ...
    private String collect = "false";  // 是否收藏

    private String wrong_collect = "false";   // 错题收藏

    // 错题练习数据
    private String finish_exercise_wrong = "false";  // 是否练习过
    @Convert(columnType = String.class, converter = StringConverter.class)
    private List<String> select_answer_wrong; // 练习过所选答案

    // 顺序练习数据
    private String finish_exercise = "false"; // 是否练习过
    @Convert(columnType = String.class, converter = StringConverter.class)
    private List<String> select_answer; // 练习过所选答案

    // 随机练习数据
    private String finish_exercise_random = "false";
    @Convert(columnType = String.class, converter = StringConverter.class)
    private List<String> select_answer_random; // 练习过所选答案

    // 章节练习数据
    private String finish_exercise_section = "false";
    @Convert(columnType = String.class, converter = StringConverter.class)
    private List<String> select_answer_section; // 练习过所选答案

    // 考前冲刺练习数据
    private String finish_exercise_drill = "false";
    @Convert(columnType = String.class, converter = StringConverter.class)
    private List<String> select_answer_drill; // 练习过所选答案

    // 难易错题练习数据
    private String finish_exercise_record = "false";
    @Convert(columnType = String.class, converter = StringConverter.class)
    ...
    public TopicBean(Long id, Long tid, int type, int subject, int chapter,
            ...
            List<String> option, String collect, String wrong_collect,
            String finish_exercise_wrong, List<String> select_answer_wrong,
            String finish_exercise, List<String> select_answer,
            String finish_exercise_random, List<String> select_answer_random,
            String finish_exercise_section, List<String> select_answer_section,
            String finish_exercise_drill, List<String> select_answer_drill,
            String finish_exercise_record, List<String> select_answer_record) {
        this.id = id;
        this.tid = tid;
        this.type = type;
        ...
        this.finish_exercise_wrong = finish_exercise_wrong;
        this.select_answer_wrong = select_answer_wrong;
...
//    D convertToDatabaseValue(P entityProperty);
    ...
    public String getWrong_collect() {
        return wrong_collect;
    }

    public void setWrong_collect(String wrong_collect) {
        this.wrong_collect = wrong_collect;
    }

    public String getFinish_exercise_wrong() {
        return finish_exercise_wrong;
    }

    public void setFinish_exercise_wrong(String finish_exercise_wrong) {
        this.finish_exercise_wrong = finish_exercise_wrong;
    }

    public List<String> getSelect_answer_wrong() {
        return select_answer_wrong;
    }

    public void setSelect_answer_wrong(List<String> select_answer_wrong) {
        this.select_answer_wrong = select_answer_wrong;
    }

    public String getFinish_exercise() {
        return finish_exercise;
    }

    public void setFinish_exercise(String finish_exercise) {
        this.finish_exercise = finish_exercise;
    }
    ...
    public String getFinish_exercise_random() {
        return finish_exercise_random;
    }

    public void setFinish_exercise_random(String finish_exercise_random) {
        this.finish_exercise_random = finish_exercise_random;
    }

    public List<String> getSelect_answer_random() {
        return select_answer_random;
    }
    ...
    public String getFinish_exercise_section() {
        return finish_exercise_section;
    }

    public void setFinish_exercise_section(String finish_exercise_section) {
        this.finish_exercise_section = finish_exercise_section;
    }

    public List<String> getSelect_answer_section() {
        return select_answer_section;
    }
    ...
    public String getFinish_exercise_drill() {
        return finish_exercise_drill;
    }

    public void setFinish_exercise_drill(String finish_exercise_drill) {
        this.finish_exercise_drill = finish_exercise_drill;
    }

    public List<String> getSelect_answer_drill() {
        return select_answer_drill;
    }
    ...
    public String getFinish_exercise_record() {
        return finish_exercise_record;
    }

    public void setFinish_exercise_record(String finish_exercise_record) {
        this.finish_exercise_record = finish_exercise_record;
    }

    public List<String> getSelect_answer_record() {
        return select_answer_record;
    }
